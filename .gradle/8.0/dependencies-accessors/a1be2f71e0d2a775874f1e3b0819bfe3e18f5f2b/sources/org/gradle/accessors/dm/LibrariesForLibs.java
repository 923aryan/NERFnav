...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public AndroidxMaterial3LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("androidx.material3"); }

        /**
         * Returns the group of libraries at androidx.material3.window
         */
        public AndroidxMaterial3WindowLibraryAccessors getWindow() { return laccForAndroidxMaterial3WindowLibraryAccessors; }

    }

    public static class AndroidxMaterial3WindowLibraryAccessors extends SubDependencyFactory {
        private final AndroidxMaterial3WindowSizeLibraryAccessors laccForAndroidxMaterial3WindowSizeLibraryAccessors = new AndroidxMaterial3WindowSizeLibraryAccessors(owner);

        public AndroidxMaterial3WindowLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at androidx.material3.window.size
         */
        public AndroidxMaterial3WindowSizeLibraryAccessors getSize() { return laccForAndroidxMaterial3WindowSizeLibraryAccessors; }

    }

    public static class AndroidxMaterial3WindowSizeLibraryAccessors extends SubDependencyFactory {

        public AndroidxMaterial3WindowSizeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for class (androidx.compose.material3:material3-window-size-class)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getClass() { return create("androidx.material3.window.size.class"); }
    ...
    public static class Material3VersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        private final Material3WindowVersionAccessors vaccForMaterial3WindowVersionAccessors = new Material3WindowVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.material3.window
         */
        public Material3WindowVersionAccessors getWindow() { return vaccForMaterial3WindowVersionAccessors; }

    }

    public static class Material3WindowVersionAccessors extends VersionFactory  {

        private final Material3WindowSizeVersionAccessors vaccForMaterial3WindowSizeVersionAccessors = new Material3WindowSizeVersionAccessors(providers, config);
        public Material3WindowVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.material3.window.size
         */
        public Material3WindowSizeVersionAccessors getSize() { return vaccForMaterial3WindowSizeVersionAccessors; }

    }

    public static class Material3WindowSizeVersionAccessors extends VersionFactory  {

        public Material3WindowSizeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: material3.window.size.class (1.1.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getClass() { return getVersion("material3.window.size.class"); }
